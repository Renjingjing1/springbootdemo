...
public class MeiTuanSchedule {
    ...
    * */
    ...
    public void mget(){
        ...
        SystemParam systemParam = new SystemParam(appid,secret);
        //组建请求参数
        ...
        for (int i =0;i<array.size();i++){
           ...
           // String bm01=  tempobj.getString("bm01");
           // String gsxx01=  tempobj.getString("gsxx01");
        ...
        for(Map map:list){
            ...
            if(obj !=null){
                ...
                for (int i = 0; i <= times; i++) {
                    ...
                    logger.info("retailListRequest----reqSig---"+reqSig);
                    //请求返回的结果，按照官网的接口文档自行解析即可
    ...
    public void retailSkuStock(){
        ...
        for (Map map:list) {
           ...
           String app_food_code= map.get("app_food_code")+"";
            ...
            retailSkuStockRequest.setApp_poi_code("666");
            retailSkuStockRequest.setFood_data("[{\"app_food_code\":\"food_0001\",\"skus\":[{\"sku_id\":\"5\",\"stock\":\"10\"},{...}]},{...}]");
            SgOpenResponse sgOpenResponse;
            try {
